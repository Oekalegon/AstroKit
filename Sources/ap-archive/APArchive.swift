...
struct APArchive: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [Search.self, Add.self, Recent.self, Info.self, ListObjects.self, Stats.self, Remove.self, Reject.self, Copy.self, Frameset.self, Stretch.self, BackfillMetadata.self]
    )
}
