// VSOP87D — Venus (heliocentric ecliptic, ecliptic of date)
...
extension PlanetSeries {
    ...
    static let venus = PlanetSeries(
        l: VenusL, b: VenusB, r: VenusR
    )

    // MARK: - L series

    private static let VenusL0: [VSOpTerm] = [
        ...
        (761.38,                    1.95014702120,     529.69096509460),
        ...
        (29.85,                     4.02176977477,     10239.58386601080),
        ...
        (26.26,                     0.54067587552,     17298.18232732620),
        ...
        (5.95,                      2.96578175391,     4732.03062734340),
        ...
        (5.58,                      0.48723384809,     522.57741809380),
        (5.327,                     3.03115417024,     10021.83728009940),
        (5.01,                      5.77375166500,     28521.09277825460),
        ...
        (2.57,                      1.20813474107,     13936.79450513400),
        ...
        (2.23,                      3.01413465913,     18875.52586977400),
        ...
        (1.36,                      2.41976595457,     38734.37832446560),
        ...
        (1.27,                      4.69374306132,     9050.81084180320),
        ...
        (0.9,                       2.74195379617,     41962.52073693740),
        (1.01,                      2.96092073452,     135.62532501000),
        ...
        (0.92,                      4.17128923588,     18734.40542291960),
        ...
        (0.62,                      4.00681042667,     9992.87290377220),
        ...
        (0.44,                      5.61490649795,     23958.63178523340),
        ...
        (0.53,                      0.71368442157,     33794.54372352860),
        ...
        (0.41,                      4.93346326003,     19264.09638801420),
        (0.38,                      3.79573358631,     8521.11987670860),
        ...
        (0.4,                       0.91999360201,     227.47613278900),
        (0.437,                     0.91420135162,     58953.14544329400),
        (0.36,                      0.82477639126,     22.77520145080),
        ...
        (0.32,                      2.84811591194,     10199.05845220940),
        ...
        (0.2,                       3.82443218090,     18314.92077904440),
        ...
        (0.15,                      2.11647586229,     17248.42530185440),
        ...
        (0.15,                      0.25029475344,     290.97286586600),
        ...
        (0.12,                      0.88536981986,     29573.36116144300),
        ...
        (0.11,                      4.96279287076,     48417.97290558199),
        ...
        (0.06,                      4.56685040226,     30426.55754319500),
        (0.062,                     4.16222812699,     42430.48572729180),
        (0.05,                      6.17899839001,     22779.43724619380),
        (0.048,                     1.52546758016,     20639.87018786000),
        (0.046,                     4.41738494249,     34570.06633485260),
        (0.037,                     4.69675087759,     44007.82926973960),
    ]

    private static let VenusL1: [VSOpTerm] = [
        (1021352943052.8981,        0.00000000000,     0.00000000000),
        ...
        (16.51,                     2.64330452640,     7.11354700080),
        (14.23,                     5.45138233941,     9153.90361602180),
        ...
        (1.72,                      4.72129626061,     10186.98722641120),
        ...
        (1.15,                      2.35531987378,     9690.70812811720),
        (1.219,                     2.27324315182,     522.57741809380),
        (1.15,                      0.81088598778,     10742.97651130560),
        ...
        (0.69,                      4.01873754171,     19651.04848109800),
        (0.532,                     4.41576130890,     574.34479833480),
        (0.54,                      2.15936134728,     16496.36139620240),
        ...
        (0.45,                      0.21279844600,     11.72935283600),
        ...
        (0.37,                      6.16895004656,     2218.75710418680),
        ...
        (0.3,                       3.76014360906,     8094.52168583260),
        ...
        (0.12,                      5.41870615047,     37724.75341974820),
        ...
        (0.09,                      4.34075776744,     29057.89729034999),
        ...
        (0.07,                      4.03868009742,     56600.27928952220),
        ...
        (0.05,                      5.69803054279,     39793.76025465480),
        ...
        (0.05,                      4.37549274002,     28513.97923125379),
        ...
        (0.04,                      3.06358586355,     813.55028395980),
        (0.04,                      2.16802870803,     59728.66805461800),
    ...
    private static let VenusL2: [VSOpTerm] = [
        (54127.076,                 0.00000000000,     0.00000000000),
        (3891.46,                   0.34514360047,     10213.28554621100),
        (1337.88,                   2.02011286082,     20426.57109242200),
        ...
        (1.46,                      6.04899046273,     529.69096509460),
        ...
        (0.06,                      5.02186497542,     19367.18916223280),
    ...
    private static let VenusL3: [VSOpTerm] = [
    ...
    private static let VenusL: [[VSOpTerm]] = [VenusL0, VenusL1, VenusL2, VenusL3, VenusL4, VenusL5]

    // MARK: - B series

    private static let VenusB0: [VSOpTerm] = [
        ...
        (6.05,                      6.26541665966,     11322.66409830440),
        ...
        (0.75,                      3.85219782842,     21228.39202354580),
        (0.7,                       1.98097957188,     3930.20969621960),
        ...
        (0.28,                      1.92925047377,     49515.38250840700),
        ...
        (0.18,                      6.19353087076,     39793.76025465480),
        (0.199,                     1.16433321880,     22805.73556599360),
        (0.18,                      3.72646417141,     1551.04522264800),
        ...
        (0.12,                      0.36076947165,     536.80451209540),
        ...
        (0.09,                      2.12423586627,     28313.28880466100),
        (0.09,                      0.39668501735,     9580.50180689780),
        (0.074,                     6.02680095550,     3723.50895892300),
        (0.081,                     5.25045057985,     10419.47109464820),
        (0.08,                      4.23724598221,     10007.09999777380),
        ...
        (0.08,                      5.62254102739,     29999.95935231900),
        ...
        (0.06,                      5.89661892920,     41962.52073693740),
        ...
        (0.04,                      5.32101847424,     42430.48572729180),
        (0.051,                     5.29186795569,     29587.58825544460),
    ]

    private static let VenusB1: [VSOpTerm] = [
        (513347.602,                1.80364310797,     10213.28554621100),
        (4380.1,                    3.38615711591,     20426.57109242200),
        ...
        (3.39,                      4.88976070903,     10988.80815753500),
        ...
        (1.6,                       1.68378002982,     20618.01935853360),
        ...
        (0.44,                      4.33400244581,     15874.61759536320),
        (0.349,                     1.31468836511,     10234.06094170340),
        (0.31,                      5.45422332781,     10192.51015071860),
        ...
        (0.05,                      4.16651052942,     13341.67431130680),
        ...
        (0.04,                      6.13293942728,     26087.90314157420),
    ...
    private static let VenusB2: [VSOpTerm] = [
        ...
        (0.09,                      5.23585072275,     10596.18207843420),
        ...
        (0.02,                      5.66581696952,     21228.39202354580),
        (0.024,                     2.17208107850,     18849.22754997420),
        (0.02,                      5.29318634138,     775.52261132400),
    ...
    private static let VenusB: [[VSOpTerm]] = [VenusB0, VenusB1, VenusB2, VenusB3, VenusB4, VenusB5]

    // MARK: - R series

    private static let VenusR0: [VSOpTerm] = [
        ...
        (39.43,                     5.39019422358,     23581.25817731760),
        ...
        (19.7,                      4.96157560245,     11322.66409830440),
        ...
        (13.18,                     3.37207825651,     13745.34623902240),
        ...
        (6.07,                      0.35337419942,     21228.39202354580),
        ...
        (3.92,                      5.56542869407,     10596.18207843420),
        ...
        (1.95,                      2.21447019683,     19786.67380610799),
        ...
        (1.14,                      5.92088900094,     13936.79450513400),
        ...
        (1.27,                      5.24647873116,     19360.07561523199),
        ...
        (0.5,                       4.20351458644,     55022.93574707440),
        ...
        (0.28,                      3.70200084294,     47623.85278608960),
        ...
        (0.16,                      1.81472642729,     10787.63034454580),
        (0.199,                     5.74259798330,     30666.15495843280),
        (0.16,                      4.46270605493,     18947.70451835760),
        ...
        (0.12,                      0.21443767468,     31022.75317085620),
        (0.128,                     2.92458887798,     7.11354700080),
        (0.15,                      5.73646272556,     632.78373931320),
        ...
        (0.1,                       5.00532389609,     10175.25787357520),
        ...
        (0.09,                      2.42353056125,     32858.61374281979),
        ...
        (0.08,                      1.58278081077,     19992.85935454519),
        ...
        (0.07,                      2.35648061034,     11794.15220700780),
        (0.08,                      2.33248094128,     38526.57435087200),
        (0.07,                      3.70454061100,     8734.41897214660),
        ...
        (0.08,                      3.41620457770,     48417.97290558199),
        (0.08,                      3.39651161571,     245.83164622940),
        ...
        (0.07,                      2.45123308846,     10218.80847051840),
        ...
        (0.05,                      1.59156823654,     18631.31264870099),
        ...
        (0.06,                      5.94659889997,     13897.66359620120),
        ...
        (0.05,                      3.70569982975,     42456.78404709160),
        ...
        (0.04,                      1.23305546260,     10228.53801739600),
        ...
        (0.04,                      3.66961416802,     10198.03307502600),
        ...
        (0.04,                      1.97645050921,     32243.49850088060),
        ...
        (0.03,                      3.34585843979,     39793.76025465480),
        (0.026,                     5.36096904409,     1478.86657406440),
    ]

    private static let VenusR1: [VSOpTerm] = [
        ...
        (3.84,                      5.66196924375,     13367.97263110660),
        ...
        (0.52,                      5.33201358267,     14143.49524243060),
        ...
        (0.33,                      0.58817502306,     16496.36139620240),
        ...
        (0.23,                      6.13406345590,     1059.38193018920),
        ...
        (0.15,                      5.02227334847,     29088.81141598500),
        ...
        (0.03,                      1.24986033487,     27461.71084806540),
    ...
    private static let VenusR2: [VSOpTerm] = [
        ...
        (0.31,                      1.38984998403,     5507.55323866740),
        ...
        (0.12,                      5.85815843789,     9153.90361602180),
        (0.16,                      2.21564938463,     3154.68708489560),
    ...
    private static let VenusR4: [VSOpTerm] = [
        (0.573,                     0.92229697820,     10213.28554621100),
        (0.04,                      0.95468912157,     20426.57109242200),
        (0.006,                     3.14159265359,     0.00000000000),
    ]

    private static let VenusR5: [VSOpTerm] = [
        (0.045,                     0.30032866722,     10213.28554621100),
        (0.002,                     5.29627718483,     20426.57109242200),
    ]

    private static let VenusR: [[VSOpTerm]] = [VenusR0, VenusR1, VenusR2, VenusR3, VenusR4, VenusR5]
